...
export interface ClientOptions {
   ...
   *
   * Defaults to process.env['SOLVICE_SHIFT_SOLVER_BASE_URL'].
   */
   ...
   * Set the log level.
   *
   * Defaults to process.env['SOLVICE_SHIFT_SOLVER_LOG'] or 'warn' if it isn't set.
   */
 ...
 */
export class SolviceShiftSolver {
  apiKey: string;
  ...
  constructor({
    ...
    const options: ClientOptions = {
      apiKey,
      ...opts,
      baseURL: baseURL || `https://api.solvice.io`,
    };

    this.baseURL = options.baseURL!;
    this.timeout = options.timeout ?? SolviceShiftSolver.DEFAULT_TIMEOUT /* 1 minute */;
    ...
    this.logLevel =
      ...
      parseLogLevel(readEnv('SOLVICE_SHIFT_SOLVER_LOG'), "process.env['SOLVICE_SHIFT_SOLVER_LOG']", this) ??
      defaultLogLevel;
  ...
  #baseURLOverridden(): boolean {
    return this.baseURL !== 'https://api.solvice.io';
  }
  ...
  static SolviceShiftSolver = this;
  static DEFAULT_TIMEOUT = 60000; // 1 minute

  static SolviceShiftSolverError = Errors.SolviceShiftSolverError;
  ...
  fill: API.Fill = new API.Fill(this);
}

SolviceShiftSolver.Fill = Fill;

export declare namespace SolviceShiftSolver {
