import fs from 'fs';
import type { ResponseLike } from 'solvice-shift-solver/internal/to-file';
import { toFile } from 'solvice-shift-solver/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('solvice-shift-solver/core/uploads');
    await expect(
